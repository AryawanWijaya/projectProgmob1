...
public class ProteinFragment extends Fragment {
    ...
    private static final String ARG_PARAM2 = "param2"; //klo mau tambah variabel tambah disini

    // TODO: Rename and change types of parameters
    private String mParam1;
    private String mParam2;// dan tambah disini

    SendMessage sm;// variabel interface yang telah dibuat dibawah poll
    ...
    //menyambungkna activity dengan fragment
    ...
    @Override
    public void onAttach(Context context) { // fungsi utk mengirimkan data dari sm ke activity, pertama kali dieksekusi sebelum onViewCrreated
