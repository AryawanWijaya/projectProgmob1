...
public class MahasiswaFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btnAddMhs =  view.findViewById(R.id.btnAddMhs);
        Button btnUpdate = view.findViewById(R.id.btnUpdateMhs);
        Button btnDelete = view.findViewById(R.id.btnDeleteMhs);
